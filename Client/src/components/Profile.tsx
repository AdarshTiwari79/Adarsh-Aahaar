...
const Profile = () => {
  ...
  return (
    <form onSubmit={updateProfileHandler} className="max-w-7xl mx-auto my-5">
      ...
      <div className="grid md:grid-col-4 md:gap-2 gap-3 my-10">
        <div className="flex items-center gap-4 rounded-sm p-2 bg-gray-200">
          ...
          <div className="w-full">
            ...
            <input
              ...
              onChange={changeHandler}
              className="w-full text-gray-600 bg-transparent focus-visible:ring-0 border-transparent outline-none border-none"
            />
          </div>
        </div>
